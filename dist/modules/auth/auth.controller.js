...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Auto-registro de clientes' }),
    ...
    (0, swagger_1.ApiResponse)({ status: 409, description: 'Correo o documento ya registrado' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Inicio de sesión exitoso, retorna JWT' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Credenciales incorrectas' }),
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Cuenta bloqueada o desactivada' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Token no válido o expirado' }),
